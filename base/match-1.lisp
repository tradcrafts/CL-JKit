...
(jkit.core:define-package :jkit.base.match* (:jkit.base.match)
  (:use :cl)
  (:import/export :jkit.base.unify*)
  (:export
...
(defun jkit.base.unify::%make-match-code% (src ptns)
...
(defun make-matcher (ptn src)
  (cond 
    ...
    ((eq :match (first ptn))
      `(unless ,(jkit.base.unify::%make-match-code% src (cdr ptn))
        (return-from |test| nil)))
        
    ((eq :unify (first ptn))
      `(unless ,(jkit.base.unify::%make-unify-code% src (cdr ptn))
        (return-from |test| nil)))
