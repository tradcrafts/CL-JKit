...
;; テスト
(eval-when (:compile-toplevel :load-toplevel :execute) (jkit.core.reader:enable-reader))

(defpackage jkit.core.1-finish-testing
  (:use :cl :jkit.core.test)
  )

(in-package :jkit.core.1-finish-testing)
