...
(jkit.core.init:define-package :jkit.core.primary-annotations ()
  (:use :cl :jkit.core.init :alexandria :anaphora :cl-annot :metabang-bind)

  (:export
   #:define-package ;; import from jkit.core.init
   #:export* ;; import from jkit.core.init
...
(in-package :jkit.core.primary-annotations)
;;;;;;;;;;;;;;;;
;; Annotation
;;;;;;;;;;;;;;;;
